    ...
    >
      ...
      <div className="p-2 sm:p-3 border-b border-default flex flex-col gap-2">
        <div className="flex justify-center sm:justify-between items-center">
          ...
          <button
            onClick={onCreate}
            className="p-1.5 rounded-full text-muted hover:bg-accent/10 hover:text-accent hover:shadow-sm transition-all duration-200 interactive-base interactive-scale"
            title="New Entry"
        ...
        <div className="relative">
          ...
          {searchQuery && (
            <button
              ...
              className="absolute right-2 top-2 sm:top-1.5 text-muted hover:text-accent hover:bg-bg-alt/50 rounded p-0.5 transition-all duration-200 interactive-base interactive-scale"
            >
