    ...
    <div className="flex items-center gap-1">
      ...
      <div className="relative">
        <button
          ...
          className="p-1.5 rounded-md transition-all duration-200 text-muted interactive-muted hover:bg-bg-alt interactive-base interactive-scale"
          title="Font Face"
        >
      ...
      <button
        ...
        className="p-1.5 rounded-md transition-all duration-200 text-muted interactive-muted hover:bg-bg-alt disabled:opacity-30 disabled:cursor-not-allowed interactive-base interactive-scale interactive-disabled"
