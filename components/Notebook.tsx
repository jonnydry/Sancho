    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 h-16 border-b border-default">
              ...
              <button
                ...
                className={`px-2.5 py-0.5 text-xs font-medium rounded leading-none transition-all duration-200 interactive-base interactive-scale ${
                  activeTab === 'saved' 
                    ...
                    : 'text-muted hover:text-default hover:bg-accent/15 hover:shadow-sm'
                }`}
              >
                Saved Items
          ...
          <button
            onClick={onClose}
            className="text-muted hover:text-default hover:bg-bg-alt/50 rounded-md p-1 transition-all duration-200 interactive-base interactive-scale"
