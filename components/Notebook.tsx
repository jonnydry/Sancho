...
export const Notebook: React.FC<NotebookProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-full bg-bg/80 backdrop-blur-md backdrop-brightness-150 dark:backdrop-brightness-100 z-[55] flex flex-col transition-all duration-300 ease-in-out ${
