    ...
    <div className="mt-4 p-6 border-t border-default">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          disabled={isLoading}
          className="flex items-center space-x-2 px-4 py-2 text-sm font-semibold text-white border border-white bg-white/10 backdrop-blur-sm rounded-lg hover:bg-white/20 hover:border-white/80 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white/50"
        >
          {isLoading ? (
